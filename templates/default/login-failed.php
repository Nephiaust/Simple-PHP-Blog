        ...
        <div class="col-md-8">
            ...
            <form class="needs-validation" novalidate method="POST">
                <div class="col-sm-6 has-validation">
                    ...
                    <input type="text" class="form-control is-invalid" id="username" name="username" placeholder="Enter your username here" required>
                ...
                <div class="col-sm-6 has-validation">
                    ...
                    <input type="password" id="password" name="password" class="form-control is-invalid" required>
                    <div class="invalid-feedback">
