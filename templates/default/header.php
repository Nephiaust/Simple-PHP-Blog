...
<body>
    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a href="<?php echo $url_path; ?>" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item"><a href="<?php echo $url_path; ?>" class="nav-link active" aria-current="page">Home</a></li>
