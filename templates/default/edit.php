...
if (isset($Edit)) {
    ...
    echo '                    <label for="firstName" class="form-label">Slug (SEO URL)</label>' . "\r\n";
    ...
    echo '                    <textarea class="form-control" id="description" style="height: 150px" name="description" required>' . $Description . '</textarea>' . "\r\n";
